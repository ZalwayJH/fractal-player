...
function TracksMenu({ setSelectedSong }) {
  ...
  return (
    <div className="h-11/12 bottom-1 shadow-black  shadow-md bg-[#0c0c0d] top-1 m-2 ml-3 border grid grid-rows-[6em_minmax(1em,_18fr)_11em]   border-white/[0.2]   select-none rounded-lg xl:w-5/12 max-w-[36rem] lg:w-4/12  md:w-3/12 transition-all ease-in-out duration-100  z-30 fixed">
